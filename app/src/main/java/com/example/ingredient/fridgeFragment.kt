...
import com.example.ingredient.adapter.todoAdapter3
...
class fridgeFragment : Fragment() {
    ...
    lateinit var todoAdapter: todoAdapter3
    ...
    override fun onCreateView(
        ...
        val rv_board : RecyclerView = view.findViewById(R.id.rvTodoList2)

        todoAdapter = todoAdapter3(this)
        ...
        todoAdapter.setItemDeleteListener(object: todoAdapter3.ItemDeleteListener {
        ...
        todoAdapter.setItemCheckListener(object : todoAdapter3.ItemCheckListener{
            override fun onClick(view: View, position:Int, itemId: Long, state:Boolean){
                CoroutineScope(Dispatchers.IO).launch{
                    if(state == true){
                        val todo = todoViewModel.getOne(itemId)
